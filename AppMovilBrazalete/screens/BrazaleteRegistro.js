...
import AppStackNavigator from "../navigation/BrazaleteStack";
            ...
            <SafeAreaView style={styles.safeArea}>
                <ScrollView style={styles.scrollView}>
                        ...
                        <View style={styles.card}>
                            ...
                            <View style={styles.textContainer}>
                                ...
                                <TouchableOpacity style={styles.connectButton}
                                   onPress={() => navigation.navigate('BrazaleteConfig')}
                                >
                    ...
                    <View style={styles.container}>
                        ...
                        <SecondCard title="Brazalete de Juan" onEdit={() => console.log("Edit pressed")} />
                        <SecondCard title="Brazalete de Alan" onEdit={() => console.log("Edit pressed")} />
                    </View>
                </ScrollView>
            </SafeAreaView>
        </>
