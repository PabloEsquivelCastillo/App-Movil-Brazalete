      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} 
        showsVerticalScrollIndicator={false} >
          ...
          <View>
            ...
            <Text style={styles.descrip}>Aqui puedes actualizar la informacion personal del cuidador seleccionado.</Text>
          </View>
                ...
                <View style={styles.inputContainer}>
                    <TextInput placeholder="Confirma la contraseña" style={styles.input} secureTextEntry/>
                    <FontAwesome name="lock" size={30} color="gray" style={styles.icon} />
                </View>
