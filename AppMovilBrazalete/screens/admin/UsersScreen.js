        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <Text style={styles.description}>Aquí se muestran todos los cuidadores activos en el sistema.</Text>
                    </View>
                    ...
                    <View key={index} style={styles.contactItem}>
                     ...
                     <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("Solicitudes")}><Text>Solicitudes</Text></TouchableOpacity>
                </View>
            </ScrollView>
        </SafeAreaView>
        </>
